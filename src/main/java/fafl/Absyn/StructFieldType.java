...
public class StructFieldType extends Type {
  public final Type type_;
  public StructFieldType(Type p1) { type_ = p1; }

  public <R,A> R accept(fafl.Absyn.Type.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof fafl.Absyn.StructFieldType) {
      fafl.Absyn.StructFieldType x = (fafl.Absyn.StructFieldType)o;

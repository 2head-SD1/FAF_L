...
public class TupleGet extends Expr {
  public final Expr expr_1, expr_2;
  public TupleGet(Expr p1, Expr p2) { expr_1 = p1; expr_2 = p2; }

  public <R,A> R accept(fafl.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof fafl.Absyn.TupleGet) {
      fafl.Absyn.TupleGet x = (fafl.Absyn.TupleGet)o;
